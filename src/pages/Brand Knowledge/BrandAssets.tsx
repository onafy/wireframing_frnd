...
const MOCK_ASSETS: any[] = [
  // Logos — 12 assets (triggers rich preview)
  // Using abstract brand/tech imagery to represent logos
  ...[
    { name: 'Telkomsel Horizontal', variant: 'Horizontal', photo: 'photo-1560179707-f14e90ef3623', usage: ['hero', 'digital', 'print'] },
    { name: 'Telkomsel Monochrome', variant: 'Monochrome', photo: 'photo-1586717791821-3f44a22fa3ff', usage: ['social', 'document'] },
    { name: 'Telkomsel Dark', variant: 'Dark', photo: 'photo-1614680376573-df3480f0c6ff', usage: ['dark_bg', 'packaging'] },
    { name: 'Telkomsel Light', variant: 'Light', photo: 'photo-1552664730-d307ca884978', usage: ['light_bg', 'print'] },
    { name: 'Telkomsel Icon', variant: 'Icon', photo: 'photo-1558618666-fcd25c85cd64', usage: ['app', 'favicon'] },
    { name: 'Telkomsel Stacked', variant: 'Stacked', photo: 'photo-1560179707-f14e90ef3623', usage: ['hero', 'print'] },
    { name: 'Telkomsel Compact', variant: 'Compact', photo: 'photo-1599305445671-ac291c95a9fc', usage: ['compact', 'mobile'] },
    { name: 'Telkomsel White', variant: 'White', photo: 'photo-1586717791821-3f44a22fa3ff', usage: ['white_bg', 'merchandise'] },
    { name: 'Telkomsel Dark Text', variant: 'Dark Text', photo: 'photo-1614680376573-df3480f0c6ff', usage: ['document', 'official'] },
    { name: 'Telkomsel Tagline', variant: 'Tagline', photo: 'photo-1552664730-d307ca884978', usage: ['campaign', 'poster'] },
    { name: 'Telkomsel No Tagline', variant: 'No Tagline', photo: 'photo-1558618666-fcd25c85cd64', usage: ['icon_only', 'app_icon'] },
  ].map((a, i) => ({
    id: `logo-${i}`,
    name: a.name,
    category: 'Logos',
    ...
    format: 'SVG',
    dim: 'Auto',
    tags: ['brand', 'primary', 'official'],
    added: '2026-03-01',
    url: `https://images.unsplash.com/${a.photo}?auto=format&fit=crop&q=80&w=400&h=300`
  })),
  // Products — 8 assets
  // Using actual product photography (shoes, tech, accessories)
  ...[
    { name: 'Running Shoe Pro — Studio', variant: 'Studio', photo: 'photo-1542291026-7eec264c27ff', dim: '1200×1200', usage: ['catalog', 'shopify'] },
    { name: 'Lifestyle Sneaker — Lifestyle', variant: 'Lifestyle', photo: 'photo-1606107557195-0e29a4b5b4aa', dim: '1200×1200', usage: ['marketplace', 'social'] },
    { name: 'Wireless Headphones — Close-up', variant: 'Close-up', photo: 'photo-1505740420928-5e560c06d30e', dim: '1200×1200', usage: ['catalog', 'shopify'] },
    { name: 'Camera Gear — Flat Lay', variant: 'Flat Lay', photo: 'photo-1491553895911-0055eca64f33', dim: '1200×1200', usage: ['flatlay', 'editorial'] },
    { name: 'Smart Watch — Model', variant: 'Model', photo: 'photo-1523275335684-37898b6baf30', dim: '1200×1200', usage: ['catalog', 'hero'] },
    { name: 'Perfume Bottle — Swatch', variant: 'Swatch', photo: 'photo-1590736704728-f4730bb52170', dim: '1200×1200', usage: ['swatch', 'social'] },
    { name: 'Sunglasses — 360', variant: '360', photo: 'photo-1572635196237-14b4007e2769', dim: '1200×1200', usage: ['360_view', 'shopify'] },
    { name: 'Backpack — Video Thumbnail', variant: 'Video Thumbnail', photo: 'photo-1553062407-98eeb64c6a62', dim: '1200×1200', usage: ['video', 'marketplace'] },
  ].map((a, i) => ({
    id: `prod-${i}`,
    name: a.name,
    category: 'Products',
  ...
  // Mascots & Characters — 3 assets
  // Using illustrated/character-style imagery
  ...[
    { name: 'Archie the Explorer', variant: 'Full Color', photo: 'photo-1560275619-4662e36fa7d0', usage: ['hero', 'mascot', 'lifestyle'] },
    { name: 'Archie Holiday 2025', variant: 'Line Art', photo: 'photo-1618005182384-a83a8bd57fbe', usage: ['seasonal', 'merch'] },
    { name: 'Archie x Collab', variant: 'Animated', photo: 'photo-1637666938753-1d9b2d3d8f4d', usage: ['collab', 'social'] },
  ].map((a, i) => ({
    id: `mascot-${i}`,
    name: a.name,
    category: 'Mascots & Characters',
    variant: a.variant,
    usage: a.usage,
    format: 'SVG',
    dim: 'Auto',
  ...
  // Patterns & Textures — 5 assets
  ...[
    { name: 'Geometric Blue Pattern', variant: 'Tileable', photo: 'photo-1557683316-973673baf926', dim: '2000×2000', usage: ['background', 'print'] },
    { name: 'Minimal Line Grid', variant: 'Seamless', photo: 'photo-1507003211169-0a1dd7228f2d', dim: '2000×2000', usage: ['textile', 'packaging'] },
    { name: 'Dot Grid Texture', variant: 'Directional', photo: 'photo-1558591710-4b4a1ae0f04d', dim: '2000×2000', usage: ['background', 'print'] },
    { name: 'Gradient Fade', variant: 'Repeating', photo: 'photo-1550684376-efcbd6e3f031', dim: '2000×2000', usage: ['gradient', 'ui'] },
    { name: 'Halftone Dots', variant: 'Random', photo: 'photo-1579546929518-9e396f3cc809', dim: '2000×2000', usage: ['print', 'texture'] },
  ].map((a, i) => ({
    id: `pattern-${i}`,
    name: a.name,
  ...
  // Photography Refs — 2 assets
  ...[
    { name: 'Campaign Ref: Urban Street', variant: 'Editorial', photo: 'photo-1509631179647-0177331693ae', dim: '4000×3000', usage: ['moodboard', 'campaign'] },
    { name: 'Campaign Ref: Retail Space', variant: 'Lifestyle', photo: 'photo-1441986300917-64674bd600d8', dim: '4000×3000', usage: ['reference', 'store'] },
  ].map((a, i) => ({
    id: `photo-${i}`,
    name: a.name,
    category: 'Photography Refs',
    variant: a.variant,
    usage: a.usage,
    format: 'JPG',
    dim: a.dim,
  ...
  // Icons — 2 assets
  ...[
    { name: 'UI Icon Set — Outline', variant: 'Outline', photo: 'photo-1611532736597-de2a5d8c4de5', dim: '24×24', usage: ['ui', 'digital'] },
    { name: 'UI Icon Set — Filled', variant: 'Filled', photo: 'photo-1614680376593-902f74cf0d41', dim: '24×24', usage: ['ui', 'dark'] },
  ].map((a, i) => ({
    id: `icon-${i}`,
    name: a.name,
    category: 'Icons',
...
const ASSET_CATEGORIES = [
  'All', 'Logos', 'Products', 'Mascots & Characters', 'Patterns & Textures', 'Photography Refs', 'Icons', 'Templates', 'Other'
];
...
export default function App() {
  const [activeMenu, setActiveMenu] = useState(window.location.pathname === '/brand-assets' ? 'assets' : 'knowledge');
  ...
  const [uploadReviewAssets, setUploadReviewAssets] = useState<any[]>([]);

  const handleAssetUpload = () => {
    setIsUploadingAssets(true);
    // Simulate AI parsing
    setTimeout(() => {
      setUploadReviewAssets([
        {
          file: 'telkomsel_horizontal_dark.png',
          name: 'Telkomsel Horizontal Dark',
          category: 'Logos',
          variant: 'Horizontal',
          usage: ['dark_bg', 'hero', 'digital'],
          confidence: 'high'
        },
        {
          file: 'IMG_2847.jpg',
  ...
  const saveUploadedAssets = () => {
    const newAssets = uploadReviewAssets.map((a, i) => ({
      id: `new-a-${Date.now()}-${i}`,
      name: a.name,
      category: a.category,
      variant: a.variant,
      ...
      url: 'https://images.unsplash.com/photo-1614680376573-df3480f0c6ff?auto=format&fit=crop&q=80&w=400&h=300'
    }));
  ...
  const filteredAssets = assets.filter(a => {
    ...
    if (assetSearch) {
      ...
      if (!a.name.toLowerCase().includes(q) && !a.tags.join(' ').toLowerCase().includes(q)) return false;
    }
    return true;
  });

  const getAssetsByCategory = (cat: string) => assets.filter(a => a.category === cat);
          ...
          <div className="flex-1 overflow-y-auto p-8 pb-20">
            ...
            {activeMenu === 'assets' && (
              <div className="max-w-5xl mx-auto animate-in fade-in duration-300">
                {/* Assets Toolbar */}
                <div className="flex items-center justify-between mb-8 bg-neutral-900/20 border border-neutral-800/60 rounded-xl p-4">
                  <div className="flex items-center gap-4 flex-1">
                    <div className="flex items-center bg-black border border-neutral-800 rounded-lg px-4 py-2.5 focus-within:border-neutral-700 w-80 transition-colors">
                      <Search size={14} className="text-neutral-500 mr-3 shrink-0" />
                      <input
                        value={assetSearch}
                        onChange={(e) => setAssetSearch(e.target.value)}
                        placeholder="Search assets or tags..."
                        className="bg-transparent border-none outline-none text-sm font-light text-white w-full"
                      />
                    </div>
                  ...
                  <button
                    ...
                    className="ml-4 shrink-0 px-4 py-2 rounded-lg bg-white text-black text-sm font-medium hover:bg-neutral-200 transition-colors flex items-center gap-2"
                  >
                    {isUploadingAssets ? <RefreshCw size={14} className="animate-spin" /> : <Upload size={14} />}
                    Upload Assets
                  </button>
                </div>
                ...
                {uploadReviewAssets.length > 0 && (
                   <div className="mb-8 border border-neutral-800 bg-neutral-900/50 rounded-xl p-6 shadow-2xl animate-in slide-in-from-top-4 duration-300">
                     <div className="flex items-center justify-between mb-6">
                       <div>
                         <h3 className="text-sm font-medium text-white flex items-center gap-2">
                           <Wand2 size={16} className="text-neutral-400" />
                           AI auto-fill complete
                         </h3>
                         <p className="text-xs text-neutral-500 mt-1">Review {uploadReviewAssets.length} assets before saving.</p>
                       </div>
                       <div className="flex gap-2 items-center">
                         <span className="text-xs text-neutral-500 mr-4 font-medium tracking-tight">
                           {uploadReviewAssets.filter(a => a.confidence === 'low' && (!a.category || !a.variant)).length > 0 
                             ? `${uploadReviewAssets.filter(a => a.confidence === 'low' && (!a.category || !a.variant)).length} asset(s) need input` 
                             : "Ready to save"}
                         </span>
                         <button onClick={() => setUploadReviewAssets([])} className="px-4 py-2 rounded-lg bg-neutral-800 text-neutral-400 text-xs font-medium hover:bg-neutral-700 transition-colors">Cancel</button>
                         <button 
                           onClick={saveUploadedAssets} 
                           disabled={uploadReviewAssets.some(a => a.confidence === 'low' && (!a.category || !a.variant))}
                           className="px-4 py-2 rounded-lg bg-white text-black text-xs font-medium hover:bg-neutral-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                         >
                           Save All
                         </button>
                       </div>
                     ...
                     <div className="space-y-4">
                       {uploadReviewAssets.map((asset, i) => (
                         <div key={i} className={`flex gap-4 p-5 border rounded-xl relative ${asset.confidence === 'low' ? 'border-amber-900/50 bg-amber-950/20' : 'border-neutral-800/60 bg-black/40'}`}>
                           {asset.confidence === 'high' && (
                             <div className="absolute top-0 right-8 -translate-y-1/2 bg-indigo-900/80 border border-indigo-700 text-indigo-300 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-widest flex items-center gap-1 shadow-lg">
                               <Sparkles size={8} /> AI Filled
                             </div>
                           )}
                           {asset.confidence === 'low' && (
                             <div className="absolute top-0 right-8 -translate-y-1/2 bg-amber-900/80 border border-amber-700 text-amber-300 text-[9px] font-bold px-2 py-0.5 rounded uppercase tracking-widest flex items-center gap-1 shadow-lg">
                               <AlertTriangle size={8} /> Low Confidence
                             </div>
                           )}
                           <div className="w-24 h-24 bg-neutral-800 rounded-lg border border-neutral-700/50 flex items-center justify-center shrink-0">
                           ...
                           <div className="flex-1 grid grid-cols-2 gap-4">
                             <div>
                               ...
                               <input value={asset.name} onChange={e => {
                                 const updated = [...uploadReviewAssets];
                                 updated[i].name = e.target.value;
                                 setUploadReviewAssets(updated);
                               }} className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-3 py-2 text-sm font-light text-white outline-none focus:border-neutral-700" />
                             </div>
                             <div>
                               <label className="block text-[10px] font-mono tracking-widest text-neutral-500 mb-2 uppercase flex justify-between">
                                 Category {asset.confidence === 'low' && !asset.category && <span className="text-amber-500">*Required</span>}
                               </label>
                               <select value={asset.category} onChange={e => {
                                 const updated = [...uploadReviewAssets];
                                 updated[i].category = e.target.value;
                                 setUploadReviewAssets(updated);
                               }} className={`w-full bg-neutral-900 border ${asset.confidence === 'low' && !asset.category ? 'border-amber-700/50' : 'border-neutral-800'} rounded-lg px-3 py-2 text-sm font-light text-white outline-none focus:border-neutral-700 appearance-none`}>
                             ...
                             <div>
                               <label className="block text-[10px] font-mono tracking-widest text-neutral-500 mb-2 uppercase flex justify-between">
                                 Variant {asset.confidence === 'low' && !asset.variant && <span className="text-amber-500">*Required</span>}
                               </label>
                               <input placeholder="e.g. Horizontal, Monochrome" value={asset.variant} onChange={e => {
                                 const updated = [...uploadReviewAssets];
                             ...
                             <div>
                               <label className="block text-[10px] font-mono tracking-widest text-neutral-500 mb-2 uppercase">Usage Context Tags (comma separated)</label>
                               <input value={asset.usage.join(', ')} onChange={e => {
                                 const updated = [...uploadReviewAssets];
                                 updated[i].usage = e.target.value.split(',').map((s: string) => s.trim());
                                 setUploadReviewAssets(updated);
                               }} className="w-full bg-neutral-900 border border-neutral-800 rounded-lg px-3 py-2 text-sm font-light text-white outline-none focus:border-neutral-700" />
                             </div>
                           </div>
                ...
                {/* Re-upload zone: shown when user already has assets but wants to add more */}
                {assets.length > 0 && uploadReviewAssets.length === 0 && (
                  <div className="mb-8 flex items-center justify-center">
                    <div
                      onClick={handleAssetUpload}
                      onDragOver={e => { e.preventDefault(); setIsDragOver(true); }}
                      onDragLeave={() => setIsDragOver(false)}
                      onDrop={e => { e.preventDefault(); setIsDragOver(false); handleAssetUpload(); }}
                      className={`w-full max-w-md py-8 px-6 rounded-xl border-2 border-dashed cursor-pointer transition-all text-center ${
                        isDragOver
                          ? 'border-indigo-500 bg-indigo-950/30'
                          : 'border-neutral-800 bg-neutral-900/20 hover:border-neutral-600 hover:bg-neutral-900/40'
                      }`}
                    >
                      <div className="flex flex-col items-center gap-2">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors ${isDragOver ? 'bg-indigo-900/50' : 'bg-neutral-900'}`}>
                          <FileUp size={18} className={isDragOver ? 'text-indigo-400' : 'text-neutral-500'} />
                        </div>
                        <div>
                          <p className={`text-sm font-medium transition-colors ${isDragOver ? 'text-indigo-300' : 'text-neutral-400'}`}>
                            {isDragOver ? 'Drop to upload' : 'Add more assets'}
                          </p>
                          <p className="text-xs text-neutral-600 mt-1">or click to browse — SVG, PNG, JPG, MP4</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {assets.length === 0 && uploadReviewAssets.length === 0 && (
                  <div className="mb-12 animate-in fade-in duration-500">
                    <div className="flex flex-col items-center justify-center py-20 px-4 border-2 border-dashed border-neutral-800 rounded-2xl bg-neutral-900/20 mb-12 hover:border-neutral-700 transition-colors">
                      <div className="w-16 h-16 bg-neutral-900 border border-neutral-800 rounded-full flex items-center justify-center mb-6">
                        <FileUp size={24} className="text-neutral-500" />
                      </div>
                      <h2 className="text-2xl font-light text-white mb-3 tracking-tight">Drop files here to get started</h2>
                      <p className="text-sm text-neutral-500 mb-8 max-w-sm text-center leading-relaxed">
                        We'll auto-detect category, variant, and usage context. Supported formats: SVG, PNG, JPG, MP4.
                      </p>
                      <button onClick={handleAssetUpload} className="px-6 py-2.5 rounded-lg bg-white text-black text-sm font-medium hover:bg-neutral-200 transition-colors shadow-xl">
                        Browse Files
                      </button>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {ASSET_CATEGORIES.filter(c => c !== 'All').map(cat => (
                        <div key={cat} className="p-5 rounded-xl border border-neutral-800/40 bg-neutral-900/10">
                          <h4 className="text-sm font-medium text-neutral-400 mb-2">{cat}</h4>
                          <p className="text-2xl font-light text-neutral-700">0</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="space-y-12">
                   {assets.length > 0 && ASSET_CATEGORIES.filter(c => c !== 'All').map(category => {
                     // If there's a filter, only show that category
                     if (assetCategory !== 'All' && assetCategory !== category) return null;

                     // Skip empty categories
                     const catAssets = getAssetsByCategory(category).filter(a => filteredAssets.includes(a));
                     
                     if (catAssets.length === 0 && assetCategory !== 'All' && !assetSearch) {
                       return (
                         <div key={category} className="text-center py-16 border border-neutral-800/40 rounded-xl bg-neutral-900/10 border-dashed">
                           <ImageIcon size={32} className="mx-auto text-neutral-800 mb-4" />
                           <h3 className="text-sm font-medium text-neutral-400 mb-1">No {category.toLowerCase()} yet</h3>
                           <p className="text-xs font-light text-neutral-500 mb-4">Upload your first asset to populate this library.</p>
                           <button onClick={handleAssetUpload} className="text-xs bg-neutral-800 text-white px-4 py-2 rounded-lg hover:bg-neutral-700 transition-colors">Upload Assets</button>
                         </div>
                       );
                     }
                     ...
                     return (
                       <div key={category}>
                         <div className="flex items-center gap-3 mb-6 border-b border-neutral-800/50 pb-2">
                           <h3 className="text-sm font-medium text-neutral-300 tracking-wide">{category}</h3>
                           <span className="text-[10px] bg-neutral-800 text-neutral-400 px-2 py-0.5 rounded-full">{catAssets.length}</span>
                         </div>
                         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                           {catAssets.map(asset => (
                             <div
                               ...
                               className="group cursor-pointer rounded-xl border border-neutral-800/60 bg-neutral-900/20 overflow-hidden flex flex-col hover:border-neutral-600 transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-black"
                             >
                               <div className="aspect-square bg-neutral-950 relative overflow-hidden border-b border-neutral-800/60 flex items-center justify-center group-hover:bg-neutral-900 transition-colors">
                                 {asset.url ? (
                                   <img src={asset.url} alt={asset.name} className="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition-opacity duration-300" />
                                 ) : (
                                   <ImageIcon size={32} className="text-neutral-700 group-hover:text-neutral-500 transition-colors" />
                                 )}
                                 <div className="absolute top-3 right-3 bg-black/80 text-[10px] font-mono tracking-widest text-neutral-400 border border-neutral-700/50 px-2 py-1 rounded backdrop-blur-md">
                                   {asset.format}
                                 </div>
                               </div>
                               <div className="p-4 flex-1 flex flex-col">
                                 <h4 className="text-sm font-medium text-white truncate" title={asset.name}>{asset.name}</h4>
                                 <p className="text-[10px] text-neutral-500 uppercase tracking-widest mt-1.5 font-mono truncate" title={asset.variant}>{asset.variant}</p>
                                 <div className="flex gap-1.5 mt-4 flex-wrap mt-auto">
                                   {asset.usage.slice(0, 2).map((tag: string, i: number) => (
                                     <span key={i} className="text-[10px] bg-neutral-800/60 text-neutral-400 px-1.5 py-0.5 rounded border border-neutral-700/30 font-mono tracking-tight">
                                       {tag}
                                     </span>
                                   ))}
                                   {asset.usage.length > 2 && (
                                     <span className="text-[10px] text-neutral-500 px-1.5 py-0.5">+{asset.usage.length - 2}</span>
                                   )}
                                 </div>
                               </div>
                             </div>
                   ...
                   {filteredAssets.length === 0 && !uploadReviewAssets.length && (
                     <div className="text-center py-24">
                       <Search size={32} className="mx-auto text-neutral-800 mb-4" />
                       <h3 className="text-lg font-light text-white mb-2">No assets found</h3>
                       <p className="text-sm font-light text-neutral-500 max-w-sm mx-auto">
            ...
            {selectedAsset && (
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
                ...
                <div className="relative w-full max-w-5xl bg-black border border-neutral-800/80 rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[85vh] animate-in zoom-in-95 duration-200">
                  {/* Left: Preview */}
                  <div className="w-full md:w-3/5 bg-neutral-950 border-b md:border-b-0 md:border-r border-neutral-800 flex items-center justify-center relative p-8 group">
                    <button onClick={() => setSelectedAsset(null)} className="absolute top-4 left-4 w-8 h-8 flex items-center justify-center bg-black/50 text-neutral-300 rounded-full border border-neutral-700 hover:bg-white hover:text-black hover:border-white transition-colors z-10 md:hidden">
                      <X size={16} />
                    </button>
                    {selectedAsset.url ? (
                      <img src={selectedAsset.url} alt={selectedAsset.name} className="w-full h-full object-contain drop-shadow-2xl" />
                    ) : (
                      <ImageIcon size={64} className="text-neutral-800" />
                    )}
                    <div className="absolute bottom-6 left-0 right-0 flex justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                       <button className="flex items-center gap-2 bg-neutral-900/80 backdrop-blur-md text-white border border-neutral-700 px-4 py-2 rounded-lg text-xs hover:bg-neutral-800 transition-colors shadow-xl">
                  ...
                  <div className="w-full md:w-2/5 flex flex-col h-full bg-black">
                    <div className="flex items-center justify-between p-5 border-b border-neutral-800 shrink-0 bg-neutral-900/10">
                       <button onClick={() => setSelectedAsset(null)} className="text-neutral-500 hover:text-white transition-colors hidden md:block">
                         <X size={18} />
                       </button>
                       <div className="flex gap-2">
                         <button className="p-2 bg-neutral-900 border border-neutral-800 rounded-lg text-neutral-400 hover:text-white hover:border-neutral-600 transition-colors"><Edit3 size={14} /></button>
                         <button className="p-2 bg-neutral-900 border border-neutral-800 rounded-lg text-neutral-400 hover:text-red-400 hover:border-red-900/50 hover:bg-red-900/10 transition-colors"><Trash2 size={14} /></button>
                       </div>
                    </div>
                    <div className="flex-1 overflow-y-auto p-6 space-y-8">
                       <div>
                         <h2 className="text-xl font-light text-white mb-3 tracking-tight">{selectedAsset.name}</h2>
                         <div className="flex gap-2">
                           <span className="text-[10px] bg-neutral-900 border border-neutral-800 text-neutral-300 px-2.5 py-1 rounded-full font-mono uppercase tracking-widest">{selectedAsset.category}</span>
                           <span className="text-[10px] text-neutral-500 border border-neutral-800 px-2.5 py-1 rounded-full font-mono uppercase tracking-widest">{selectedAsset.variant}</span>
                         </div>
                       </div>
                       
                       <div className="p-5 bg-neutral-900/40 border border-neutral-800/60 rounded-xl space-y-5">
                         <div>
                           <div className="text-[10px] font-mono uppercase tracking-widest text-neutral-500 mb-2 flex justify-between">
                             <span>Asset ID</span>
                             <button className="text-blue-400 hover:text-blue-300 flex items-center gap-1 transition-colors"><Copy size={10} /> Copy ID</button>
                           </div>
                           <code className="text-xs bg-black border border-neutral-800 px-2 py-1 rounded text-neutral-300">{selectedAsset.id}</code>
                           <p className="text-[10px] text-neutral-600 mt-2">Use this ID in Cmd+K to force the AI to retrieve this specific asset.</p>
                         </div>
                         <div className="grid grid-cols-2 gap-6 pt-5 border-t border-neutral-800/50">
                           <div>
                             <div className="text-[10px] font-mono uppercase tracking-widest text-neutral-500 mb-1.5">Format</div>
                             <p className="text-sm font-light text-white">{selectedAsset.format}</p> /* Changed text-neutral-300 to white */
                           </div>
                           <div>
                             <div className="text-[10px] font-mono uppercase tracking-widest text-neutral-500 mb-1.5">Dimensions</div>
                             <p className="text-sm font-light text-white">{selectedAsset.dim}</p> /* Changed text-neutral-300 to white */
                           </div>
                         </div>
                       </div>

                       <div>
                         <div className="text-[10px] font-mono uppercase tracking-widest text-neutral-500 mb-3 flex items-center gap-2">Usage Context</div>
                         <div className="flex flex-wrap gap-2">
                           {selectedAsset.usage.map((t: string) => (
                             <span key={t} className="text-xs bg-neutral-900/80 text-neutral-300 px-3 py-1.5 rounded-lg border border-neutral-800 flex items-center gap-2">
                               <CheckSquare size={12} className="text-neutral-500" /> {t}
                             </span>
                           ))}
                         </div>
                         <p className="text-xs text-neutral-500 mt-3 font-light leading-relaxed">
                           AI prioritizes this asset when the generated context matches these usage tags.
                         </p>
                       </div>

                       {selectedAsset.tags.length > 0 && (
                         <div>
                           <div className="text-[10px] font-mono uppercase tracking-widest text-neutral-500 mb-3">General Tags</div>
                           <div className="flex flex-wrap gap-2">
                             {selectedAsset.tags.map((t: string) => (
                               <span key={t} className="text-xs text-neutral-400 bg-neutral-900 border border-neutral-800 px-3 py-1.5 rounded-lg flex items-center gap-1.5">
                                 <Tag size={12} className="text-neutral-500" /> {t}
                               </span>
                             ))}
                           </div>
                         </div>
                       ...
                       <div className="pt-6 border-t border-neutral-800 mt-8">
                         <div className="flex justify-between text-[11px] uppercase tracking-widest font-mono text-neutral-500">
                           <span>Added</span>
                           <span className="text-neutral-400">{selectedAsset.added}</span>
                         </div>
                       </div>
                    </div>
                  </div>
            ...
            {/* FOOTER BRANDING */}
            <div className="absolute bottom-4 right-8 pointer-events-none z-0">
